...
class QiyenameSpiderMiddleware(object):
...
class QiyenameDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
    ...
    def process_request(self, request, spider):
        ...
        request.headers["Cookie"] = "UM_distinctid=1696c2d45e688-076d1d4b551f45-3c604504-100200-1696c2d45e710e; CNZZDATA1080356=cnzz_eid%3D2080583188-1552294210-%26ntime%3D1552985885; CNZZDATA1639035=cnzz_eid%3D1232938458-1552989471-%26ntime%3D1552989471; ASPSESSIONIDAAQTRADT=GGJBIOFANGLBCFGJPABIKECC",
        request.headers["Host"] = "www.jia12.com",
        request.headers["Referer"] = "http://www.jia12.com/XingmingKu/",
