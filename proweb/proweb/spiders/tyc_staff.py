...
from proweb.items import ProwebStaffItem
settings = get_project_settings()

class TycStaffSpider(scrapy.Spider):
    '''
        主要人员
    '''
    name = 'tyc_staff'
    ...
    def start_requests(self):
        ...
        while True:
            ...
            for item in allkeys:
                ...
                if not redis_pool.sismember("hasStaffSign","hasstaff:"+key):
                    url = "https://www.tianyancha.com/pagination/staff.xhtml?ps=30&pn=1&id=%s&name=%s"%(key,quote_plus(val['name']))
    ...
    def parse(self, response):
        ...
        if response.text:
            ...
            if table_trs:
                for tr in table_trs:
                    table_dict = {}
                    table_dict["staff_name"] = tr.xpath("./td[2]//a[@class='link-click']/text()").extract_first() if tr.xpath("./td[2]//a[@class='link-click']/text()") else "-"
                    table_dict['staff_type'] = tr.xpath("./td[3]//text()").extract_first() if tr.xpath("./td[3]//text()") else "-"
                ...
                if next_ul:
                    if next_ul.css("li a.-next"):
                        ...
                        sign = True
                    url = "https://www.tianyancha.com/pagination/staff.xhtml?ps=30&pn=%s&id=%s&_=1543820978893&name=%s"%(next_num,meta['id'],meta['name'])
