...
from proweb.items import ProwebEquityItem
settings = get_project_settings()

class TycEquitySpider(scrapy.Spider):
    '''
        股权出质
    '''
    name = 'tyc_equity'
    ...
    def start_requests(self):
        ...
        while True:
            ...
            for item in allkeys:
                ...
                if not redis_pool.sismember("hasEquitySign","hasequity:"+key):
                    url = "https://www.tianyancha.com/pagination/equity.xhtml?ps=30&pn=1&id=%s&name=%s"%(key,quote_plus(val['name']))
        ...
        if table_trs:
            ...
            if next_ul:
                if next_ul.css("li a.-next"):
                    ...
                    sign = True
                url = "https://www.tianyancha.com/pagination/equity.xhtml?ps=30&pn=%s&id=%s&name=%s"%(next_num,meta['id'],meta['name'])
