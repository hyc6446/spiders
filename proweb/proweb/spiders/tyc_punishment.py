...
from proweb.items import ProwebPunishmentItem
settings = get_project_settings()

class TycPunishmentSpider(scrapy.Spider):
    '''
        行政处罚(工商局)
    '''
    name = 'tyc_punishment'
    ...
    def start_requests(self):
        ...
        while True:
            ...
            for item in allkeys:
                ...
                if not redis_pool.sismember("hasPunishmentSign","haspunishment:"+key):
                    url = "https://www.tianyancha.com/pagination/punish.xhtml?ps=30&pn=1&id=%s&name=%s"%(key,quote_plus(val['name']))
        ...
        if table_trs:
            ...
            if next_ul:
                if next_ul.css("li a.-next"):
                    ...
                    sign = True
                url = "https://www.tianyancha.com/pagination/punish.xhtml?ps=30&pn=%s&id=%s&name=%s"%(next_num,meta['id'],meta['name'])
