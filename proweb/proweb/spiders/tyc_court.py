...
from proweb.items import ProwebCourtItem
    ...
    def start_requests(self):
        ...
        while True:
            ...
            for item in allkeys:
                ...
                if not redis_pool.sismember("hasCourtSign","hascourt:"+key):
                    url = "https://www.tianyancha.com/pagination/court.xhtml?ps=30&pn=1&id=%s&name=%s"%(key,quote_plus(val['name']))
        ...
        if table_trs:
            ...
            if next_ul:
                if next_ul.css("li a.-next"):
                    ...
                    sign = True
                url = "https://www.tianyancha.com/pagination/court.xhtml?ps=30&pn=%s&id=%s&name=%s"%(next_num,meta['id'],meta['name'])
