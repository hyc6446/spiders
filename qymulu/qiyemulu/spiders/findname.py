...
class FindnameSpider(scrapy.Spider):
    ...
    def start_requests(self):
        self.redis_pool = redis.StrictRedis(host=settings['REDIS_HOST'], port=settings['REDIS_PORT'],
        ...
        while True:
            ...
            for key in allkeys:
                print(key)
                url = "https://api2.tianyancha.com/services/v3/search/sNorV2/%s?sortType=0&pageSize=100&pageNum=1" % quote_plus(
                    key)
